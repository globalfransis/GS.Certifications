...
{
    public class CreateConceptoGastoTipoCommandValidator : AbstractGSValidator<CreateConceptoGastoTipoCommand>
    {
        private readonly ICertificationsDbContext _context;
        public CreateConceptoGastoTipoCommandValidator(ICertificationsDbContext context)
        {
