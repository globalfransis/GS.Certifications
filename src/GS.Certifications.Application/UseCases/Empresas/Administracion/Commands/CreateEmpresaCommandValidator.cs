...
{
    public class CreateEmpresaCommandValidator : AbstractGSValidator<CreateEmpresaCommand>
    {
        private readonly ICertificationsDbContext context;
        public CreateEmpresaCommandValidator(ICertificationsDbContext context)
        {
