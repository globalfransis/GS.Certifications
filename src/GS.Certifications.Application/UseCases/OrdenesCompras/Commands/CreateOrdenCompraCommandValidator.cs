...
{
    public class CreateOrdenCompraCommandValidator : AbstractGSValidator<CreateOrdenCompraCommand>
    {
        private readonly ICertificationsDbContext _context;
        public CreateOrdenCompraCommandValidator(ICertificationsDbContext context)
        {
