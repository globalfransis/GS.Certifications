...
public class UpdateComprobanteCommandValidator : AbstractGSValidator<UpdateComprobanteCommand>
{
    public UpdateComprobanteCommandValidator(IStringLocalizer<Shared> loc)
    {
