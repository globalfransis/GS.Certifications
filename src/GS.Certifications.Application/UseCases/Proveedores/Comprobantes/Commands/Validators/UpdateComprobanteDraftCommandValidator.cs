...
public class UpdateComprobanteDraftCommandValidator : AbstractGSValidator<UpdateComprobanteDraftCommand>
{
    public UpdateComprobanteDraftCommandValidator(IStringLocalizer<Shared> loc)
    {
        ...
        RuleFor(c => c.Detalles.Where(d => !d.Deleted))
