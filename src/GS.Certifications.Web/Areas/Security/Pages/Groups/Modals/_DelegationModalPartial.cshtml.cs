...
namespace GS.Certifications.Web.Areas.Security.Pages.Groups.Modals;

public class GroupDelegationPartialModel : IMapFrom<GroupCrudDto>
{
    ...
    public GroupDelegationPartialModel(ICurrentCompanyService currentCompanyService,
                                       IMediator mediator)
    {
    ...
    public class MappingProfile : Profile
    {
        ...
        {
            CreateMap<GroupCrudDto, GroupDelegationPartialModel>()
