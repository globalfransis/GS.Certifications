...
namespace GS.Certifications.Web.Areas.Security.Pages.Roles.Modals
{
    public class RoleDelegationPartialModel : IMapFrom<RoleCrudDto>
    {
        ...
        public RoleDelegationPartialModel(ICurrentCompanyService currentCompanyService,
                                          IMediator mediator)
        {
        ...
        public class MappingProfile : Profile
        {
            ...
            {
                CreateMap<RoleCrudDto, RoleDelegationPartialModel>()
