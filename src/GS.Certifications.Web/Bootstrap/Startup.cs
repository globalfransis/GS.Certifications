...
using GS.Certifications.Web.Common.Serialization;
using GS.Certifications.Web.Common.Services;
using GS.Certifications.Web.Common.Services.Common;
using GS.Certifications.Web.Common.Services.Token;
using GS.Certifications.Web.Common.Session;
using GS.Certifications.Web.Filters;
using GS.Certifications.Web.Hubs;
using GS.Certifications.Web.Middlewares;
...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        AddApplicationImplementations(services);
    ...
    /// </summary>
    private static void AddApplicationImplementations(IServiceCollection services)
    {
        ...
        services.AddScoped<ISupplierContextDataTempStoreService, SupplierContextDataSessionStoreService>();
