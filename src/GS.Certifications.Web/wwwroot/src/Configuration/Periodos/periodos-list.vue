<template>
    <div>
        ...
        <periodos-filter v-model="parameters" @clear="onClear()" @search="onSearch" />

        <br />

        <div class="col-12 d-flex justify-content-between align-items-center mt-2 mb-2">
            <p class="h5 m-0">Listado de Períodos</p> <!-- Modificar según el caso -->
            ...
            <table :id="`${idTable}`" convert-to-datatable-manual server-side-paging
                ...
                <thead class="table-top">
                    <tr class="text-center align-middle">
                        <th data-column="Año" class="text-center">Año</th>
                        <th data-column="NumeroPeriodo" class="text-center">Número</th>
                        <th data-column="FechaInicio" datatable-datetime class="text-center">Fecha de Inicio</th>
                        <th data-column="FechaFin" datatable-datetime class="text-center">Fecha de Fin</th>
                ...
                <tbody>
                    ...
                    <template v-for="item in list">
                        <tr :key="item.id">
                            <td class="text-right align-middle">{{ item.año }}</td>
                            <td class="text-right align-middle">{{ item.numeroPeriodo }}</td>
                            <td class="text-right align-middle">{{ item.fechaInicio | uidate }}</td>
                            <td class="text-right align-middle">{{ item.fechaFin | uidate }}</td>
                            <td class="text-right align-middle">{{ item.estado }}</td>
...
import periodosFilter from './periodos-filter.vue';
