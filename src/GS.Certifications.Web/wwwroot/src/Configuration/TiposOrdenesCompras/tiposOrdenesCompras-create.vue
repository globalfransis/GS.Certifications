    ...
    <div ref="top">
        <div class="col-12">
            <div class="col-12 mt-4">
                <p class="h5">Alta del Tipo de Documento de Compra</p> <!-- Por ejemplo: Alta de Usuario -->
            </div>
            <div class="card">
                <div class="card-body">
                    <div class="row">
...
import TipoOrdenCompraCreateDto from './TipoOrdenCompraCreateDto' // Modificar por la clase dto correspondiente
...
export default {
    ...
    data: function () {
        return {
            ...
            tipoOrdenCompraDto: new TipoOrdenCompraCreateDto(),
