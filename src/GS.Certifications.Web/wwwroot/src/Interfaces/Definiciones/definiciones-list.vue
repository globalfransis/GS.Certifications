<template>
    <div>
        ...
        <definiciones-filter v-model="parameters" @clear="onClear()" @search="onSearch" />
...
import definicionesFilter from "./definiciones-filter.vue";
