                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-12 mb-4 row">
                            <div class="col-8">
                                ...
                                <importar-comprobante idModal="__modal_ComprobanteArchivo" ref="importarComprobante"
                                    ...
                                    :empresaPortalId="comprobante.empresaId"
                        ...
                        <div class="col-12 row">
                            <div :id="comprobanteArchivoDivId" class="col-6" style="height: 150vh;">
                                ...
                                <iframe style="width: 100%; height: 90%; border: none;">
                                </iframe>
                            </div>
                                ...
                                <!-- <div class="col-12 d-flex justify-content-between align-items-center mb-4">
                                    ...
                                    <div class="form-group col-lg-6 col-sm-12 mb-2 required">
                                        ...
                                        <input type="text" class="form-control"
                                            v-model="comprobante.codigoAutorizacion">
                                        <span class="text-danger field-validation-error">
                                ...
                                <table :id="`${idTable}`" class="table table-bordered table-hover">
                                    <thead class="table-top">
                                        <tr class="text-center align-middle">
                                            ...
                                            <th v-if="comprobante.comprobanteTipoId != FACTURA_B && comprobante.comprobanteTipoId != FACTURA_C"
                                                class="w-5" scope="col">IVA (%)</th>
...
export default {
    ...
    methods: {
        ...
        async onComprobanteAnalyzed(e) {
            // this.errorBag.clear();
            // this.uiService.onlyDestroyDataTablesManual(this.idTable);

            // this.comprobante = new Comprobante(e[0]);

            // this.comprobante.empresaId = this.$route.query.empresaId;
            // this.getDatosProveedorAsync();
        ...
        async init() {
            // Si no hay permisos de alta o no se especificó proveedor, volvemos a la lista
            if (!this.grants.create || !this.$route.query.empresaId) this.$router.push({ name: "home" });
            else {
                this.comprobante.empresaId = this.$route.query.empresaId;
        ...
        async getDatosProveedorAsync() {
            ...
            await this.$store.dispatch("getDatosProveedorAsync", this.comprobante.empresaId)
                .then((res) => {
                    this.comprobante.domicilioPro = res.direccion;
                    this.comprobante.nroIdentificacionFiscalPro = res.identificadorTributario;
                    this.comprobante.categoriaTipoEmisorId = res.tipoResponsableId;
