<template>
    <div ref="top">
                        ...
                        <div class="col-12 row">
                            ...
                            <div :id="comprobanteFormularioDivId" class="col-6 row">
                                ...
                                <div class="col-12 mb-2 mt-2 d-flex justify-content-end"
                                    v-if="(comprobante.comprobanteEstadoId == CONFIRMADO || comprobante.comprobanteEstadoId == APROBADO || comprobante.comprobanteEstadoId == AUTORIZADO) && comprobante.estadoValidacionARCAId != VALIDADA">
        ...
        <div class="col-12 d-flex justify-content-end gap-2 mb-3 mt-3" v-if="currentLayoutMode != LayoutMode.File">
            ...
            <button :disabled="comprobante.propietarioActualId != BACKOFFICE"
                v-if="comprobante.comprobanteEstadoId != AUTORIZADO" @click.prevent="saveAsync"
                class="btn btn-secondary btn-sm">
                <i class="fas fa-save"></i>
                Guardar
            </button>
            <accept-button :disabled="!grants.update || comprobante.propietarioActualId != BACKOFFICE"
                @click="updateAsync">
    ...
    methods: {
        ...
        async verifyAsync() {
            if (this.comprobante.estadoValidacionARCAId == VALIDADA) {
                if (
                    await this.uiService.confirmActionModal(
                        `¿Está seguro que desea constatar el comprobante en ARCA?`,
                        "Aceptar",
                        "Cancelar"
                    )
                ) {
