<template>
    <div>
        ...
        <div class="col-12 d-flex justify-content-between align-items-center mt-2 mb-2">
            ...
            <button :disabled="!grants.create || !parameters.empresaId" type="button" class="btn btn-outline-primary btn-sm" @click="create">
            ...
            <table :id="`${idTable}`" convert-to-datatable-manual server-side-paging
                ...
                <thead class="table-top">
                    <tr class="text-center align-middle">
                        ...
                        <th data-column="Empresa.RazonSocial">Proveedor</th>
                        ...
                        <th style="width: 5.5% !important;" data-column="FechaRegistracion" datatable-datetime>Fecha Carga</th>
                        ...
                        <th class="w-5" no-sort-datatable>Lectura QR</th>
                        <th class="w-5" no-sort-datatable>Validación QR</th>
                        <th class="w-5" no-sort-datatable>Validación Cmp.</th>
...
export default {
    ...
    methods: {
        ...
        create() {
            ...
            this.$router.push({ name: "create", query: { empresaId: this.parameters.empresaId } });
        },
        seeDetail(id) {
            // Limpiamos la lista antes de navegar
            this.$store.dispatch("clearList");
