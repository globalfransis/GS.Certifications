    ...
    <div ref="top">
        <div class="col-12">
            <div class="col-12 mt-4">
                <p class="h5">Alta de Empresa</p> <!-- Por ejemplo: Alta de Usuario -->
            </div>
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div v-if="listaConceptosGastos && listaConceptosGastos.length > 0" class="form-group col-lg-3 col-sm-12 mb-4">
                            <label class="control-label">Conceptos de Gastos</label><span class="text-danger">*</span>
                            <div>
                                        ...
                                        <tr v-if="i.mode.isDetail && !i.deleted" :key="index">
                                            ...
                                            <td data-toggle="tooltip" class="text-center align-middle">
                                                <div class="d-inline-flex">
                                                    <inline-edit @click="updateMoneda(i, index)"
    ...
    methods: {
        ...
        validacionDatosObligatorios(){
            ...
            if(this.empresaDto.ordenesComprasTiposId.length === 0 && this.listaDocumentosCompras.length !== 0){
                validacion = false;
                this.errorBag.addError("ordenesComprasTiposId", ["Se debe agregar un Documento como minimo"]);
            }
            if(this.empresaDto.conceptosGastosTiposId.length === 0 && this.listaConceptosGastos.length !== 0){
                validacion = false;
                this.errorBag.addError("conceptosGastosTiposId", ["Se debe agregar un Concepto como minimo"]);
            }
