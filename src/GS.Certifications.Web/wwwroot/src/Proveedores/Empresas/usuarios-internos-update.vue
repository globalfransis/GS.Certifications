            ...
            <div class="card">
                <div class="card-body">
                    <div class="col-12 mb-4">
                        <p class="h5 m-0">Modificación del Usuario {{ this.usuarioInternoDto.email }}</p> <!-- Modificar según el caso -->
                    </div>
                    <div class="row">
                        <div class="form-group col-lg-3 col-sm-12 mb-4">
                            <label class="control-label">Email</label><span class="text-danger">*</span>
                            <input disabled type="text" class="form-control" v-model="usuarioInternoDto.email">
                        </div>
                        <div class="form-group col-lg-3 col-sm-12 mb-4">
    ...
    computed: {
        ...
        listaRolesAgregados: {
            ...
            set(values) {
                ...
                this.usuarioInternoDto.roles = values
    ...
    methods: {
        async getAsync(){
            ...
            return await new ajax()
                ...
                .then((res) => {
                    this.usuarioInternoDto = new UsuarioInternoDto(res);
        ...
        async save(){
            ...
            await this.modificarUsuarioInterno(this.usuarioInternoDto);
        },
        async modificarUsuarioInterno(usuarioInternoDto) {
            this.errorBag.clear();
