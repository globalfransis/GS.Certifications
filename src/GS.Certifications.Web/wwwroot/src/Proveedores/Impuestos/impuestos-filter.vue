                    ...
                    <form method="get">
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-sm-12 mb-4">
                                <label class="control-label">Código AFIP</label>
                                <input type="text" class="form-control" v-model="parameters.codigoAFIP">
                            </div>
                            <div class="col-lg-3 col-sm-12 mb-4">
                                <label class="control-label">Valor</label>
                                <input type="number" class="form-control" v-model="parameters.valor" step="0.01">
                            </div>
                            <div class="col-lg-3 col-sm-12 mb-4">
                                <label class="control-label">Tipo</label>
                                <tipoImpuesto-select v-model="parameters.tipoId"/>
                            </div>
