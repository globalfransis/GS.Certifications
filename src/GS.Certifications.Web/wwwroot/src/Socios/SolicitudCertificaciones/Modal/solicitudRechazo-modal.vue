        ...
        <div class="modal-dialog modal-dialog-centered grid-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">{{loc["Rechazar Solicitud"]}} {{ solicitud.id }}</h4>
                ...
                <div class="modal-body">
                    ...
                    <textarea id="motivoRechazoTxtAreaModal" class="form-control" enable cols="20" rows="4"
                        v-model="solicitud.motivoRechazo"></textarea>
                </div>
                <div class="modal-footer gap-2">
                    <accept-button :disabled="!solicitud.motivoRechazo" @click="reject">
...
export default {
    ...
    methods: {
        reject() {
            this.$emit("solicitudRechazada", this.solicitud.motivoRechazo);
            this.modalClosed();
        },
