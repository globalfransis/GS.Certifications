<template>
    <div>
        ...
        <template-filter v-model="parameters" @clear="onClear()" @search="onSearch" />

        <br />

        <div class="col-12 d-flex justify-content-between align-items-center mt-2 mb-2">
            <p class="h5 m-0">Listado</p> <!-- Modificar según el caso -->
...
import templateFilter from './template-filter.vue';
