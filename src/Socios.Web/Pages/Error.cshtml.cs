...
public class ErrorModel : PageModel
{
    ...
    [BindProperty] public string InnerException { get; set; }
    [BindProperty] public string StackTrace { get; set; }
    ...
    private void CaptureExceptionData()
    {
        ...
        string innerException = exceptionHandlerPathFeature?.Error.InnerException?.Message;
