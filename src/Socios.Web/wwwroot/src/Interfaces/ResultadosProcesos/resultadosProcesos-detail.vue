    ...
    <div ref="top">
        <div class="col-12">
            <div class="col-12 mt-4">
                <p class="h5">Proceso {{ this.proceso.id }}</p>
            </div>
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group col-lg-3 col-sm-12 mb-4">
                            <label class="control-label">Última Modif. Estado</label>
            ...
            <div class="col-12 mb-3 mt-3">
                ...
                <div class="card-title d-flex justify-content-between align-items-center mt-2 mb-2">
                    <h5 class="fw-bold">Reglas Enforzadas</h5>
                </div>
                        <table class="
                      ...
                      " convert-to-datatable-manual no-paging :id="`reglasEnforzadas-proceso${proceso.id}`">
                            <thead class="table-top">
                                <tr class="text-center">
                                    ...
                                    <th class="col">Regla</th>
                                    <th class="col">Consecuencia</th>
                                    <th class="col">Valor</th>
                                    <th class="col">Valor Relacionado</th>
                                </tr>
                            </thead>
                            <tbody>
