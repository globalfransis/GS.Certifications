...
export default class Comprobante {
    constructor(dto) {
        ...
        this.importeImpuestosInternos = dto ? dto.importeImpuestosInternos ? dto.importeImpuestosInternos : 0 : 0;
        this.importeOtrosTributosProv = dto ? dto.importeOtrosTributosProv ? dto.importeOtrosTributosProv : 0 : 0;
        this.importePercepcionIVA = dto ? dto.importePercepcionIVA ? dto.importePercepcionIVA : 0 : 0;
        this.importePercepcionIIBB = dto ? dto.importePercepcionIIBB ? dto.importePercepcionIIBB : 0 : 0;
