<template>
    <div ref="top">
        <div class="col-12">
            <div class="col-12 sticky-header mt-4">
                        ...
                        <div class="col-12 row">
                            ...
                            <div :id="comprobanteFormularioDivId" class="col-6 row">
                                ...
                                <div class="form-group col-lg-6 col-sm-12 mb-2">
                                    ...
                                    <input class="form-control" :valie="comprobante.cotizacion | currency">
                                    <span class="text-danger field-validation-error">
                        ...
                        cd.alicuota }}
                                ...
                                <div v-if="comprobante.comprobanteEstadoId == RECHAZADO"
                                    ...
                                    <textarea id="motivoRechazoTxtArea" disabled class="form-control" enable cols="20"
                                        rows="4" v-model="comprobante.motivoRechazo"></textarea>
                                </div>
                            </div>
        ...
        <div class="col-12 d-flex justify-content-end gap-2 mb-3 mt-3" v-if="currentLayoutMode != LayoutMode.File">
            <edit-button :disabled="comprobante.propietarioActualId != PROVEEDOR"
                v-if="comprobante.comprobanteEstadoId != CONFIRMADO && comprobante.comprobanteEstadoId != APROBADO && comprobante.comprobanteEstadoId != AUTORIZADO"
            ...
            <!-- <accept-button v-if="comprobante.estadoValidacionARCAId == VALIDADA && comprobante.comprobanteEstadoId == CONFIRMADO" :disabled="!grants.update && comprobante.estadoValidacionARCAId != VALIDADA" @click="approveAsync">
                Aprobar</accept-button>
            <accept-button v-if="comprobante.estadoValidacionARCAId == VALIDADA && comprobante.comprobanteEstadoId == APROBADO" :disabled="!grants.update && comprobante.estadoValidacionARCAId != VALIDADA" @click="authorizeAsync">
...
export default {
    ...
    methods: {
        setLayout(mode) {
            mode.apply(this.comprobanteArchivoDivId, this.comprobanteFormularioDivId);
