    ...
    <div ref="top">
        <div class="col-12">
            <div class="col-12 mt-4">
                ...
                <p class="h5">Certificación {{ solicitudCertificacion.certificacion }} {{ solicitudCertificacion.vigenciaDesde && solicitudCertificacion.vigenciaHasta ? `(${solicitudCertificacion.vigenciaDesde | uidate}-${solicitudCertificacion.vigenciaHasta | uidate})` : ''  }}</p>
            </div>
            <div class="card">
                <div class="card-body">
                    <div class="row">
